                 ...
                 <table class="table table-striped table-borderless">
                  ...
                  <div class="modal-body">
                    <table class="table table-responsive">
                      ...
                      @if($oItem->orderId==$item->id)
                        <tr>
                          ...
                          <td>
                            <img src="{{URL::asset('Source/products/' .$oItem->picture)}}" width="100px">
                          </td>
                          <td>
                            {{ $oItem->price}}
                          </td>
                   ...
                   <td>
                       ...
                       <a onclick="return confirm('Do you want to delete')" href="{{URL::to('deleteOrder/'.$item->id)}}" class="btn btn-danger">Delete</a>
                    </td>
                  </tr>
                 @endforeach
